...
```
## Output Waveform
![image](https://github.com/user-attachments/assets/dd0831b7-8e6e-46d3-af89-8c51291bdb00)

## Results
Thus a Python program for the modulation and demodulation of QPSK is successfully simulated and verified.
